...
class InputCustom extends StatefulWidget {
  ...
  final void Function() inactiveButton;
      ...
      builder: (context, ref, child) {
        if (ref.read(stepProvider) == 'choose_departure') {
          ref.listen(departureLocationProvider, (previous, next) {
            ...
            //     .setDepartureLocation(next);
            inputController.text =
                '${next.structuredFormatting!.mainText!}, ${(next.structuredFormatting!.secondaryText!).replaceFirst(RegExp(r',[^,]*$'), ', TP.HCM')}';
          });
        }
