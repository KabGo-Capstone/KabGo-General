...
class RemindVehicleBack extends ConsumerStatefulWidget {
  static const path = 'remind_person_image';
  static const name = 'remind_person_image';
  const RemindVehicleBack({super.key});

  @override
  ConsumerState<RemindVehicleBack> createState() => _RemindVehicleBackState();
}

class _RemindVehicleBackState extends ConsumerState<RemindVehicleBack> {
  void _setImage(File image) {
    ref.read(vehicleImageProvider.notifier).setVehicleBack(image);
    // setState(() {});
  }
                          ...
                          Row(
                            children: [
                              SizedBox(
                                ...
                                height: 150,
                                child: Image.asset(
                                    'assets/images/register/vehicle_back.JPG'),
                              ),
                            ],
                          ),
                          const SizedBox(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              buildBulletPoint(
                                  'Chụp theo hình chữ L để thấy được cốp xe, gương chiếu hậu, biển số xe và toàn bộ xe'),
