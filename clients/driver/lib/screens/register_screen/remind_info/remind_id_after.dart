...
class RemindIdAfter extends ConsumerStatefulWidget {
  static const path = 'remind_person_image';
  static const name = 'remind_person_image';
  const RemindIdAfter({super.key});

  @override
  ConsumerState<RemindIdAfter> createState() => _RemindIdAfterState();
}

class _RemindIdAfterState extends ConsumerState<RemindIdAfter> {
  void _setImage(File image) {
    print(image);
    ref.read(driverProvider.notifier).setIdImageAfter(image);
  }
                          ...
                          Row(
                            children: [
                              SizedBox(
                                ...
                                height: 150,
                                child: Image.asset(
                                    'assets/images/register/before_id1.JPG'),
                              ),
                              const SizedBox(
                              ...
                              SizedBox(
                                ...
                                height: 150,
                                child: Image.asset(
                                    'assets/images/register/before_id2.JPG'),
                              ),
                            ],
                          ),
                          const SizedBox(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              buildBulletPoint('Còn hạn ít nhất 1 tháng'),
                              const SizedBox(height: 8),
                              buildBulletPoint(
                                  'Công dân Việt Nam từ 18 tới 60 tuổi (Nam tối đa 60, Nữ tối đa 55)'),
                              const SizedBox(height: 8),
                              buildBulletPoint(
                                  'Mặt sau là mặt có ngày cấp, dấu vân tay'),
                            ],
                          ),
                        ),
                      ],
