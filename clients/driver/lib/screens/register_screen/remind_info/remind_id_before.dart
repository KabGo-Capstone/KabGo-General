...
class RemindIdBefore extends StatefulWidget {
  static const path = 'remind_person_image';
  static const name = 'remind_person_image';
  const RemindIdBefore({super.key});

  @override
  State<RemindIdBefore> createState() => _RemindIdBeforeState();
}

class _RemindIdBeforeState extends State<RemindIdBefore> {
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 8),
                              buildBulletPoint(
                                  'Mặt trước CMND/CCCD là mặt có ảnh và thông tin cá nhân (tên, ngày tháng năm sinh, địa chỉ,...)'),
                              const SizedBox(height: 8),
                              buildBulletPoint(
