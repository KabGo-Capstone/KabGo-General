...
class RemindVehicleLeft extends ConsumerStatefulWidget {
  static const path = 'remind_person_image';
  static const name = 'remind_person_image';
  const RemindVehicleLeft({super.key});

  @override
  ConsumerState<RemindVehicleLeft> createState() => _RemindVehicleLeftState();
}

class _RemindVehicleLeftState extends ConsumerState<RemindVehicleLeft> {
  void _setImage(File image) {
    ref.read(vehicleImageProvider.notifier).setVehicleLeft(image);
    // setState(() {});
  }
